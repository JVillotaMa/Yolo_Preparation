...
# Move both image and label files to the new directories (in the same folder)
for image in train_images:
    # Move image
    shutil.move(os.path.join(source_images_dir, image), os.path.join(new_images_dir, 'train', image))
    # Move corresponding label
    shutil.move(os.path.join(source_labels_dir, image.replace('.jpg', '.txt')), os.path.join(new_images_dir, 'train', image.replace('.jpg', '.txt')))

for image in val_images:
    # Move image
    shutil.move(os.path.join(source_images_dir, image), os.path.join(new_images_dir, 'val', image))
    # Move corresponding label
    shutil.move(os.path.join(source_labels_dir, image.replace('.jpg', '.txt')), os.path.join(new_images_dir, 'val', image.replace('.jpg', '.txt')))
